...
#define SAMPLEAPP_PROCESS_UI_UART_EVT           0x0040
...
extern uint8 zclSampleTemperatureSensor_battRemaining;
/*********************************************************************
 * FUNCTIONS
 */

 /*
  *  Application task entry point for the ZStack Sample Temperature Sensor Application
  */
 extern void zclSampleTemperatureSensor_task(NVINTF_nvFuncts_t *pfnNV);
